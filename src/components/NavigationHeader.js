...
export default function NavigationHeader() {
  ...
  return (
    <>
      <header className="bg-gradient-to-r from-slate-900 via-slate-950 to-slate-900 shadow-sm shadow-slate-900/30 border-b border-purple-800/30 sticky top-0 z-50 backdrop-blur-lg">
