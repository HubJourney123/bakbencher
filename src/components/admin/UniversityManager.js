// src/components/admin/UniversityManager.js
'use client';
...
export default function UniversityManager() {
  ...
  const handleDelete = async (id) => {
    if (!confirm('Are you sure? This will delete all associated departments and courses.')) {
      return;
    }
  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Bangladesh University of Engineering & Technology"
              required
            />
          </div>
          <div>
      ...
      {/* Universities List */}
      <div>
        <h3 className="text-lg font-medium mb-4">Existing Universities ({universities.length})</h3>
